...
def generate_tleap_with_bonds(pdb_input):
    ...
    # Step 3: Write make_hydrogens.in
    make_h_file = os.path.join(output_dir, "make_hydrogens.in")
    with open(make_h_file, "w") as mh:
        mh.write("source leaprc.protein.ff19SB\n")
        mh.write(f"abc = loadpdb ../{pdb_input}\n")
        mh.write("savepdb abc first_with_hydrogens.pdb\n")
        mh.write("quit\n")
